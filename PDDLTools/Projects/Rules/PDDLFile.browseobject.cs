...
namespace PDDLTools.Projects
{
    ...
    internal partial class PDDLFileBrowser
    {
        ...
        /// <summary>Initializes a new instance of the PDDLFileBrowser class.</summary>
        internal PDDLFileBrowser(Microsoft.VisualStudio.ProjectSystem.Properties.IRule rule)
        {
            this.rule = rule;
        }
        ...
        internal PDDLFileBrowser(Microsoft.VisualStudio.ProjectSystem.ConfiguredProject configuredProject, System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog> catalogs, string context, string file, string itemType, string itemName) : 
                this(GetRule(System.Collections.Immutable.ImmutableDictionary.GetValueOrDefault(catalogs, context), file, itemType, itemName))
        {
        }
        
        /// <summary>Initializes a new instance of the PDDLFileBrowser class.</summary>
        internal PDDLFileBrowser(Microsoft.VisualStudio.ProjectSystem.ConfiguredProject configuredProject, System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog> catalogs, string context, Microsoft.VisualStudio.ProjectSystem.Properties.IProjectPropertiesContext propertyContext) : 
                this(configuredProject, catalogs, context, GetContextFile(propertyContext), propertyContext.ItemType, propertyContext.ItemName)
        {
        }
        
        /// <summary>Initializes a new instance of the PDDLFileBrowser class that assumes a project context (neither property sheet nor items).</summary>
        internal PDDLFileBrowser(Microsoft.VisualStudio.ProjectSystem.ConfiguredProject configuredProject, System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog> catalogs) : 
    ...
    internal partial class ProjectProperties
    {
        ...
        private static System.Func<System.Threading.Tasks.Task<System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog>>, object, PDDLFileBrowser> CreatePDDLFileBrowserPropertiesDelegate = new System.Func<System.Threading.Tasks.Task<System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog>>, object, PDDLFileBrowser>(CreatePDDLFileBrowserProperties);
        
        private static PDDLFileBrowser CreatePDDLFileBrowserProperties(System.Threading.Tasks.Task<System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog>> namedCatalogs, object state)
        {
            ProjectProperties that = ((ProjectProperties)(state));
            return new PDDLFileBrowser(that.ConfiguredProject, namedCatalogs.Result, "Project", that.File, that.ItemType, that.ItemName);
        }
        
        /// <summary>Gets the strongly-typed property accessor used to get and set PDDL file properties.</summary>
        internal System.Threading.Tasks.Task<PDDLFileBrowser> GetPDDLFileBrowserPropertiesAsync()
        {
            ...
            return namedCatalogsTask.ContinueWith(CreatePDDLFileBrowserPropertiesDelegate, this, System.Threading.CancellationToken.None, System.Threading.Tasks.TaskContinuationOptions.ExecuteSynchronously, System.Threading.Tasks.TaskScheduler.Default);
        }
        ...
        internal bool TryGetCurrentPDDLFileBrowserPropertiesSnapshot(out PDDLFileBrowser snapshot, [System.Runtime.InteropServices.OptionalAttribute()] [System.Runtime.InteropServices.DefaultParameterValueAttribute(true)] bool requiredToMatchProjectVersion)
        {
            snapshot = null;
            ...
            if (this.TryGetCurrentCatalogSnapshot(out catalogSnapshot))
            {
                ...
                Microsoft.VisualStudio.ProjectSystem.Properties.IRule rule = this.GetSnapshotRule(catalogSnapshot.Value, "Project", PDDLFileBrowser.SchemaName);
                if ((rule != null))
                {
                    snapshot = new PDDLFileBrowser(rule);
                    return true;
                }
            }
            return false;
